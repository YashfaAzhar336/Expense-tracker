...
public class myadapterexpense extends RecyclerView.Adapter<myadapterexpense.myviewholder>
{
    ...
    public myadapterexpense(ArrayList<model> dataholder) {
    ...
    {
        holder.dname.setText("Expense Type: "+dataholder.get(position).getType());
        holder.dcontact.setText("Expense Date: "+dataholder.get(position).getDate());
        holder.demail.setText("Expense Amount: "+String.valueOf((int) dataholder.get(position).getAmount()));
    }
